...
> Voir aussi le repo jumeau [`killersql`](https://github.com/Axolotty/killersql) qui propose une version sans service systemd.
...
```bash
git clone https://github.com/Axolotty/sqlkiller.git
cd sqlkiller
```
